...
var EmptyMessage = React.createClass({displayName: "EmptyMessage",
  render: function() {
    return (
      React.createElement("div", {className: "empty-message"}, "No Data Found to build Carousel")
    );
  }
});
  ...
  render: function() {
    ...
    return (
      ...
      React.createElement("a", {href: this.props.url}, 
        React.createElement("img", {src: this.props.imagePath, alt: this.props.imageAlt})
       ), 
        React.createElement("a", {href: this.props.url}, 
